...
#define PERCEPTION_REGISTER_REGISTERER(base_class)                            \
    ...
    {                                                                         \
        typedef ::cem::fusion::Any Any;                                       \
        typedef ::cem::fusion::FactoryMap FactoryMap;                         \
                                                                              \
    public:                                                                   \
        static base_class *GetInstanceByName(const ::std::string &name)       \
        {                                                                     \
            FactoryMap &map = ::cem::fusion::GlobalFactoryMap()[#base_class]; \
...
#define PERCEPTION_REGISTER_CLASS(clazz, name)                    \
    namespace {                                                   \
    class ObjectFactory##name : public cem::fusion::ObjectFactory \
    {                                                             \
    public:                                                       \
        virtual ~ObjectFactory##name() {}                         \
        virtual ::cem::fusion::Any NewInstance()                  \
        {                                                         \
            return ::cem::fusion::Any(new name());                \
        }                                                         \
    };                                                            \
    __attribute__((constructor)) void RegisterFactory##name()     \
    {                                                             \
        ::cem::fusion::FactoryMap &map =                          \
            ::cem::fusion::GlobalFactoryMap()[#clazz];            \
